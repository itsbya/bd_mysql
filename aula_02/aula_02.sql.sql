...
-- Comanod de Manipulação de dados
INSERT INTO tb_produtos(nome, quantidade, data_validade, preco)
VALUES ("tomate", 1000, "2026-03-24", 8.99);

INSERT INTO tb_produtos(nome, quantidade, data_validade, preco)
VALUES ("banana", 15000, "2026-03-04", 12.50),
("morango", 15000, "2026-03-04", 22.00),
("alface", 500, "2026-03-04", 12.50),
("beterraba", 4000, "2026-03-04", 9.50);
...
SELECT nome, DATE_FORMAT(data_validade, '%d/%m/%y') AS Data_Validade, CONCAT('R$', FORMAT(preco, 2, 'pt_BR'))
AS preco FROM 
tb_produtos;
